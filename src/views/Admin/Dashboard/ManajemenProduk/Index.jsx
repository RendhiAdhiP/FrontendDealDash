...
export default function Index() {
    ...
    const { data: produks, isLoading, refetch: refetchProduks } = useProduks({
        onError: (err) => {
            console.error(err)
            ...
            {isLoading ? (
                ...
                <>
                    ...
                    <section className="flex flex-col gap-5">
                        ...
                        <Link to='/admin/dashboard/manajemen-produk/tambah  ' className="flex gap-2 px-3 py-2 bg-primary w-max rounded-lg text-white text-sm">
                        ...
                        <div className="flex flex-col overflow-x-auto shadow-md sm:rounded-lg gap-4">
                            <Table title={['No', 'Nama Produk', 'Foto',]} datas={produks?.data.data} row={['nama']}
