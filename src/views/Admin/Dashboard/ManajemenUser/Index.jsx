    ...
    return (
        <>
            ...
            {isLoading || deleteIsLoading || isLoadingPagination ? (
                ...
                <>
                    <section>
                        <h3 className="text-2xl text-balck font-medium">{(logged.role == 'Superadmin' || logged.role == 'Admin Create') ? 'Manajemen User' : 'User'}</h3>
                    </section>

                    <section className="flex flex-col gap-5">

                        {(logged.role == 'Superadmin' || logged.role == 'AdminCreate') && (
                        ...
                        <div className="flex flex-col overflow-x-auto shadow-md sm:rounded-lg gap-4">
                            <Table
                                title={['No', 'Nama', 'Email', 'Kota Asal', 'Action']}
